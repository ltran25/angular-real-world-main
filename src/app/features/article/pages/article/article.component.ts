...
export default class ArticleComponent implements OnInit {
  ...
  onToggleFavorite(favorited: boolean): void {
    ...
    if (favorited) {
      ...
      console.log(`Article favorited: ${this.article.slug} (count: ${this.article.favoritesCount})`);
    } else {
      this.article.favoritesCount--;
      console.log(`Article unfavorited: ${this.article.slug} (count: ${this.article.favoritesCount})`);
    }
  }
